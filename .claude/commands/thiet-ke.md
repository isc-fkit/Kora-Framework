...
- ✋ Gate 2: cho user chọn project Design (đã có trong `projects/_registry.md` hay tạo mới).
- Sinh design brief từ tri thức trong `docs/` rồi mở/hướng dẫn Claude Design.
