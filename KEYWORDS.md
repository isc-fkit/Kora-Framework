...
| Quét / cập nhật Jira | "quét jira", "lấy dữ liệu mới từ jira", **"cập nhật dữ liệu mới từ jira"** | *cập nhật dữ liệu mới từ jira* → hỏi nguồn nếu ≥2 |
...
| Gửi mail báo cáo 🔒 | "gửi mail báo cáo", "email tiến độ cho team" | *gửi mail báo cáo cho team* |
| Đặt lịch quét/sync | "đặt lịch quét jira", "tự động đồng bộ" | *đặt lịch quét jira 8h sáng* |
| Báo cáo tiến độ 🔒 | "báo cáo tiến độ", "tiến độ dự án", "cập nhật tiến độ" | *cập nhật tiến độ dự án FA* → hỏi nguồn → project |
...
| Xem phiên bản | "đang cài bản nào", "phiên bản hiện tại" | *đang cài bản nào?* (chỉ đọc) |
| Cập nhật APP | "cập nhật phiên bản", "cập nhật ứng dụng", "có bản mới không" | *cập nhật phiên bản* |
